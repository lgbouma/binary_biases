...
\added{
It seems likely that to consistently account for binarity in
planet occurrence rate calculation, one must stipulate a
population inference model with parameters controlling both the
planet and binary star populations.
...
The NASA {\it TESS} mission should provide ample opportunity
for such a study.
}
