...
\begin{align}
    ...
    %&=
    %\frac{1}{1+\mu} \left(
    %\Gamma_0(r\a) + \frac{n\b}{n\s} \left[
    %2^{3/2}\,2^{1/2} \Gamma_1(2^{1/2}r\a)
    %+
    %2^{3/2}\,2^{1/2} \Gamma_2(2^{1/2}r\a)
    %\right]
    %\right).
    %
\end{align}
...
\acknowledgements{
It was a pleasure discussing this study with T.
Barclay, W.  Bhatti, and F. Dai.  This work made use of NASA's
