...
radius distribution of planets, and also the relative numbers of planets 
...
detected planets, the planet is more likely to orbit primary. 
%
\end{abstract}
%
\keywords{
...
\begin{figure}[!tb]
    ...
    \caption{
        ...
        will have apparent radii $r\a = r\p/\sqrt{2}$ (see 
...
To generalize the procedure of Sec.~\ref{sec:simplest}, we consider a SNR 
