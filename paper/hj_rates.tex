...
\tablenotetext{a}{
    ...
    4.9$. They required signal to noise $>10$ for planet detection.
    }
\tablenotetext{b}{
    Petigura+ (in prep)'s planet sample includes all KOIs with $Kp<14.2$, with 
    a statistically insignificant number of fainter stars with HZ planets and 
    multiple transiting planets.
    Their stellar sample begins with the Mathur et al., (2017)'s catalog of 
